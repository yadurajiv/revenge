...
package com.yadurajiv.revenge
{
	...
	public class level1 extends FlxState 
	{
		...
		[Embed(source = 'data/map.png')] private var img_map:Class;
		[Embed(source = 'data/tileset.png')] private var img_tileSet:Class;
		[Embed(source = 'data/aye.png')] private var img_player:Class;
		[Embed(source = 'data/exit.png')] private var img_exit:Class;
		
		private var _map:FlxTilemap;
		
		private var _player:FlxSprite;
		private var _playerSpeed:Number = 40;
		private var _playerJump:Number = 200;
		private var _flagWalking:Boolean = false;
		...
		override public function create():void 
		{
			...
			_map.loadMap(FlxTilemap.imageToCSV(img_map), img_tileSet, 10, 10, FlxTilemap.AUTO);
			add(_map);
			
			/**
			 * adding the exit door with which we will check an overlap later for the player
			 */
			_exit = new FlxSprite(420, 190, img_exit);
			add(_exit);
			...
			_player.loadGraphic(img_player, true, true, 32, 32);
